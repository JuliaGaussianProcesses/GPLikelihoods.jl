@testset "CategoricalLikelihood" begin
    for args in ((), (softmax,), (SoftMaxLink(),))
        @test CategoricalLikelihood(args...) isa CategoricalLikelihood{SimplexVariant,SoftMaxLink}
    end
    @test CategoricalLikelihood(softmax, CurvedVariant()) isa CategoricalLikelihood{CurvedVariant,SoftMaxLink}
